    ...
    return (
        <div>
            ...
            <div className="flex overflow-x-auto overflow-y-hidden  flex-nowrap dark:text-gray-800 mt-8">
                ...
                <a rel="noopener noreferrer" href="#" className="flex items-center flex-shrink-0 px-5 py-3 space-x-2 border-2 border-b-0 rounded-t-lg dark:border-gray-200 dark:text-gray-900">

                    <span>Read Books</span>
                </a>
                <a rel="noopener noreferrer" href="#" className="flex items-center flex-shrink-0 px-5 py-3 space-x-2 border-b-2 dark:border-gray-200 dark:text-gray-600">
            ...
            <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 ">
                ...
                <ul className="flex flex-col divide-y divide-gray-700 dark:divide-gray-300">
                    ...
                    <button type="button" className="px-6 py-2 border rounded-md bg-violet-400 dark:bg-violet-600 text-gray-900 dark:text-gray-50 border-violet-400 dark:border-violet-600">
